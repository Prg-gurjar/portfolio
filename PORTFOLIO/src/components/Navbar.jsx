        ...
        <div className="flex justify-between items-center h-16">
            <div className="flex space-x-2">
                ...
                <h1 className="font-semibold text-xl cursor-pointer">
                    Pragati Gurja<span className="text-green-500 text-2xl">r</span>
            ...
            <div>
                ...
                <div onClick={()=>setMenu(!menu)} className="md:hidden">{menu?<IoIosClose size={24}/>:<AiOutlineMenu size={24}/>}</div>
            </div>
        </div>
        {/*mobile navbar */}
        {menu &&(
        <div className='bg-white'>
           <ul className="md:hidden flex flex-col h-screen items-center justify-center space-y-3 text-l">
                {navItems.map(({id,text})=>(
